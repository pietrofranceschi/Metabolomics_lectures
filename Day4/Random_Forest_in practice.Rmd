...
To do that, we first construct a model on all the data (to have the minimu possible bias), and then we look to the variable importance in that model


```{r}
full_model <- randomForest(Gender~., data = rf_df, mtry = 6)
...
Which givs a picture slightly different from PCA. Remember, however, that RF is a supervised classifier wile PCA is not
