...
~~**The objective of data analysis is to find "organization" inside the matrix**~~


~~**Our organization should be also statistically robust**~~: if someone redo my experiment the results should be the same 😉
...
## The problem: The course of dimensionality
