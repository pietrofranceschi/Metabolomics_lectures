...
<div style="background-color:#73AD21;padding:20px;border-radius: 15px;color:black;">
  <p>Analytical correlation are always stronger than biological ones!</p>
</div>
...
```{r echo=FALSE, fig.height=5, fig.width=5, message=FALSE, warning=FALSE, fig.align='center',out.width="50%"}
library(cowplot)
library(ggpubr)
