...
* Fro each sample we calculate summary **statistics**, typically the **mean**
...
2. Calculate the distribution of the mean level of cholesterol in groups of 50 people (mind the gap! ... it is not the distribution of cholesterol in the population!)
