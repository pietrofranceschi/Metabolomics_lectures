...
* _p-values_ deals with probability of obaining by chance, not with the strength of an effect
...
## for a set of different sample sizes we calculate 100 samplings and for each one p values and cohen d
