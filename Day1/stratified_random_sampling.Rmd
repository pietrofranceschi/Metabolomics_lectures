...
As we can see, the estimate has variance (:-P), and it is centered around the correct value for the population mean. It is also normally distributed, but this you already know from the previous practical ...
