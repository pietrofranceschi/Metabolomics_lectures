...
The element X[i,j] contains the value of variable `j` in the sample `i`
...
> 3. To "see" what happens in the large space a clever idea is to ~~PROJECT~~ the samples in a lower dimensional space
...
* Complex methods can be attractive but they could be misleading
* Methods will hardly work when the number of samples is too small!
* Complex does not necessarily mean more powerful
