...
::: incremental
1. multivariate imputation uses the value of samples which are close in the multivariate space to select a good number (`missMDA` package, KNN imputation, ... ). This works well if data are missing at random ...
