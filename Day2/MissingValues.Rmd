...
- Every concetration between zero and the detection limit will not be detected
...
How many NAs are acceptable **depends on the experimental design** 
...
- multivariate imputation uses the value of "close" samples to select a good number (`missMDA` package)
...
- the imputation strategy should be not "aware" of the experimental design
