...
We now save the output which will be used for the subsequent statistical analysis

```{r}
save(DM,feat, file = "processed_wines_data.RData")
```
...
sample_vs_qc <- ifelse(raw_data$color == "X","QC","S")
