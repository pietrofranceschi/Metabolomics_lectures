...
* **prefilter:** this is an initial filter which will consider valid only ion traces which are preserving a signal of more than 50000 counts for at least 3 scans.
...
cwp <- CentWaveParam(peakwidth = c(5, 30),    ## expected range of chromatographic peak width
                     ...
                     noise = 6000)            ## minimum signal to be considered
cwp
```
...
* the injection order (to spot analytical drifts)
